...
export default createStore({
    ...
    posts: [
      {
        articleId: 0,
        authorName: "",
        headerUserImg: require("../assets/pfp1.jpg"),
        headerDate: "2023-10-2",
        content: "Looking for a test subject.",
        photoUrls: [require("../assets/post1.jpg")],
        likes: 0,
      },
      {
        articleId: 1,
        authorName: "",
        headerUserImg: require("../assets/pfp2.jpg"),
        headerDate: "2022-12-31",
      ...
      },
      {
        articleId: 2,
        authorName: "",
        headerUserImg: require("../assets/pfp3.jpg"),
        headerDate: "2023-08-09",
        content: "Looking for a collaborator on my new song!!!",
        photoUrls: [],
        likes: 0,
      },
      {
        articleId: 3,
        authorName: "",
        headerUserImg: require("../assets/pfp4.jpg"),
        headerDate: "2022-01-15",
        content:
          "Looking for a fourth member to our hackathon team! It's a 8 week long process but it requires a lot of commitement. Worth 6 EAP!",
        photoUrls: [],
        likes: 0,
      },
      {
        articleId: 4,
        authorName: "",
        headerUserImg: require("../assets/pfp5.jpg"),
        headerDate: "2023-08-28",
        content:
      ...
      },
      {
        articleId: 5,
        authorName: "",
        headerUserImg: require("../assets/pfp6.jpg"),
        headerDate: "2022-01-15",
        content: "Pretty flowers I took photos of :)",
        photoUrls: [
          require("../assets/post6,1.jpg"),
          require("../assets/post6,2.jpg"),
          require("../assets/post6,3.jpg"),
        ],
  ...
  actions: {
    IncrementLikesAct: (act, id) => {
      setTimeout(function () {
        act.commit("IncrementLikes", id);
      }, 50);
    },
    ResetLikesAct: (act) => {
      console.log("pressed");
